...
const temples = [
    ...
    },
    {
        ...
        area: 26683,
        imageUrl:
            "https://churchofjesuschristtemples.org/assets/img/temples/manila-philippines-temple/manila-philippines-temple-68248.jpg"
    },
    {
...
const templePictures = document.querySelector('.temple-pictures')


function createTempleCard(filteredTemples) {
    document.querySelector(".temple-pictures").innerHTML = "";
    filteredTemples.forEach((temple) => {
        ...
        imageUrl.alt = temple.templeName;
        ...
        templePictures.appendChild(card);
    }
    )
};
